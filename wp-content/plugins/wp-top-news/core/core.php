		...
		<div class="wtn-admin-sidebar" style="width: 20%; float: left;">
			<div class="postbox">
				...
				<div class="inside centered">
					...
					<p style="margin-bottom: 1px! important;"><a href="https://topnewswp.com/contact/" target="_blank" class="button button-primary">Get Support</a></p>
				</div>
			</div>
			<div class="postbox">
				<h3 class="hndle"><span>More About Pro Features</span></h3>
				<div class="inside centered">
					<p style="margin-bottom: 1px! important;"><a href="https://topnewswp.com/" target="_blank" class="button button-primary">Pro Features</a></p>
				</div>
			</div>
			<div class="postbox">
