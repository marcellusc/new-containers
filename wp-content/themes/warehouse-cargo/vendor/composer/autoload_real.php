...
class warehouse_cargo_ComposerAutoloaderInit75f95ca3778976eb5c1bf35fe42ac3d4
{
    private static $loader;

    public static function warehouse_cargo_loadClassLoader($class)
    {
    ...
    public static function warehouse_cargo_getLoader()
    {
        if (null !== self::$loader) {
            return self::$loader;
        }
