...
class Warehouse_Cargo_Loader {
	 ...
	 * @return void
	 */
	public function warehouse_cargo_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function warehouse_cargo_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function warehouse_cargo_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function warehouse_cargo_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->warehouse_cargo_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function warehouse_cargo_load( $class ) {
