<?php 
function transportex_page_menu_args( $args ) {
	if ( ! isset( $args['show_home'] ) )
		$args['show_home'] = true;
	return $args;
}
add_filter( 'wp_page_menu_args', 'transportex_page_menu_args' );

 
function transportex_fallback_page_menu( $args = array() ) {
	...
	$list_args['title_li'] = '';
	$list_args['walker'] = new transportex_walker_page_menu;
...
class transportex_walker_page_menu extends Walker_Page{
